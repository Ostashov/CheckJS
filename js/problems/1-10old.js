...
problems[2] = {
    ...
    "statement": "Написать безымянную функцию, результатом которой является разность двух чисел А и В.<br><br><b>Входные данные:</b><br>Функция принимает аргумент - массив из двух чисел - [A, B].<br><br><b>Выходные данные:</b><br>Результатом функции является число - разность чисел A и B.<br><br><b>В решении ошибка!</b>",
    "code" : "function (data) {\n\
    var result = data[0] + data[1];\n\
    return result;\n\
}"
...
problems[3] = {
    ...
    "statement": "Написать безымяную функцию, результат которой является сумма цифр исходного числа.<br><br><b>Входные данные:</b><br>Функция принимает аргумент - число в виде строки.<br><br><b>Выходные данные:</b><br>Результатом функции является число - сумма цифр исходного числа.<br><b>Без кода</b>",
    "code": ""
}
